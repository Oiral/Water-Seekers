...
public class BbRigidbodyController : MonoBehaviour
{
    ...
    public PlayerMovementInputController inputController;
    ...
    void Update()
    {
        lateralSpeed = inputController._move.x * Speed;
        forwardSpeed = inputController._move.y * Speed;
        jumping = inputController.jumpValue > 0.5f && DateTime.Now - lastJump > jumpDelay;
    }
